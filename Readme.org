...
#+END_SRC
** Configure Emacs
Change src_shell{~/org/} to your folder of choice.
...
*** Linux
Add src_shell{~/.local/share/applications/org-protocol.desktop} file with following content:
...
Add src_shell{~/org/org-linkz/Linkz.html} to your browser bookmarks.
